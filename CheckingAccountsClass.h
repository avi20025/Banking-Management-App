...
public:
  ...
  static void  setCheckingMinimumFl(float checkingMinimum ) 
  { checkingMinimumFl = checkingMinimum;/*$$*/ }

  static float getCheckingMinimumFl(void) 
  { return checkingMinimumFl; /*$$*/; }

  static void  setChargePerCheckFl(float chargePerCheck)
  { chargePerCheckFl = chargePerCheck;/*$$*/ }

  static float getChargePerCheckFl(void)
  {
    return chargePerCheckFl; /*$$*/
  }
